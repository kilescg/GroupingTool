...
"font-size: 12pt;")
        ...
        self.gridLayout_2.addWidget(self.edgeComboBox, 1, 0, 1, 1)
        ...
        self.edgeScanButton = QtWidgets.QPushButton(self.groupBox)
        self.edgeScanButton.setObjectName("edgeScanButton")
        self.gridLayout_2.addWidget(self.edgeScanButton, 1, 1, 1, 1)
        self.edgeNote = QtWidgets.QLabel(self.groupBox)
        self.edgeNote.setObjectName("edgeNote")
        self.gridLayout_2.addWidget(self.edgeNote, 2, 0, 1, 1)
        ...
        self.childScanButton = QtWidgets.QPushButton(self.groupBox)
        self.childScanButton.setObjectName("childScanButton")
        self.gridLayout_3.addWidget(self.childScanButton, 1, 1, 1, 1)
        self.childComboBox = QtWidgets.QComboBox(self.groupBox)
        self.childComboBox.setObjectName("childComboBox")
        self.gridLayout_3.addWidget(self.childComboBox, 1, 0, 1, 1)
        ...
        self.macPrefixLineEdit_1 = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.macPrefixLineEdit_1.sizePolicy().hasHeightForWidth())
        self.macPrefixLineEdit_1.setSizePolicy(sizePolicy)
        self.macPrefixLineEdit_1.setObjectName("macPrefixLineEdit_1")
        self.verticalLayout_3.addWidget(self.macPrefixLineEdit_1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edgeSearchLineEdit.setText(_translate("MainWindow", "keyword"))
        self.edgeSearchButton.setText(_translate("MainWindow", "Search"))
        self.edgeScanButton.setText(_translate("MainWindow", "Scan QR"))
        self.edgeNote.setText(_translate("MainWindow", "Notes :"))
        ...
        self.childScanButton.setText(_translate("MainWindow", "Scan QR"))
        ...
        self.macPrefixLineEdit_1.setPlaceholderText(_translate("MainWindow", "xx_xx"))
        ...
        self.pushButton.setText(_translate("MainWindow", "Clear Group"))
